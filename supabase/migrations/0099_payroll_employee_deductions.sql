-- =====================================================================
-- 0099 — เฟส 9b กลุ่ม BE (docs/06-accounting-features-roadmap.md, หมวด 0.2 gate + T150) — ★★★
--   (เดิมวางแผนเป็น 0097 แต่เลข 0097/0098 ถูกใช้ไปแล้วโดยกลุ่ม BC/BG ตอน rebase เข้า main จึงเลื่อนมาเป็น 0099)
