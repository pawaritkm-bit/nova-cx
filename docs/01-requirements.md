...
- FR-SV-11 ~~รางวัลจูงใจ~~ **ยกเลิก (decision ผู้ใช้ 2026-07-15: ไม่เอารางวัล/แต้ม/ส่วนลด)** — ไม่มีการ์ดรางวัลหน้ายืนยัน + ไม่มีตั้งค่ารางวัลในหลังบ้าน
...
- FR-SC-04 **ส่งครั้งแรก + เตือนอัตโนมัติทาง LINE ได้สูงสุด 1 ครั้ง หลังส่งครั้งแรก 1 วัน** (ถ้ายังไม่ตอบ) แล้วหยุด ไม่ทวง LINE อีก (decision ผู้ใช้ 2026-07-15: จำกัด 1 ครั้งกันรบกวน); หยุดทันทีเมื่อ ตอบแล้ว/ยกเลิกบริการ/ขอไม่รับ/Do Not Contact/บล็อก
- FR-SC-04c **บังคับประเมิน + ไม่มี DNC (decision ผู้ว่าจ้าง 2026-07-15, override ข้อเสนอทีม):** แบบประเมินทุกชนิดถือเป็นส่วนหนึ่งของบริการ ลูกค้าต้องประเมิน — **ยกเลิกสถานะ/flow "ขอไม่รับ (Do Not Contact)" ทั้งหมด** (รวม Form D). *ยังคงหน้า PDPA consent ขั้นต่ำ (ยินยอมเก็บ/ใช้ข้อมูล+AI) ไว้ตามกฎหมาย* · ทีมรับทราบความเสี่ยง PDPA ด้านการบังคับ/ตัด opt-out การติดต่อแล้ว
- FR-SC-04b **โทรตามด้วยคน:** dashboard แสดงสถานะตอบแล้ว/ยังไม่ตอบ; **นักบัญชี/ทีมโทรตามลูกค้าที่ยังไม่ประเมินได้** (โทรส่วนตัว human touch) + บันทึก "โทรตามแล้ว" ลง log — คนละช่องกับเตือน LINE อัตโนมัติ; เห็นเบอร์ติดต่อเฉพาะลูกค้าในความรับผิดชอบ (RLS scope) และเห็นแค่ "ตอบ/ยังไม่ตอบ" ไม่เห็นเนื้อหาคำตอบ
