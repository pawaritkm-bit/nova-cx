...
- FR-SV-11 **รางวัลจูงใจ (optional):** ให้แต้ม/ส่วนลดเล็กๆ เมื่อลูกค้า **ทำแบบประเมินครบ** — แสดงในหน้ายืนยัน; **ให้เพราะ "ทำครบ" เท่านั้น ไม่ผูกกับคะแนนที่ให้** (กันบิดเบือน/ไม่ขัด C-06) และเป็นรางวัลที่บริษัทตั้งค่าไว้ (config) ไม่ใช่ AI รับปาก (ไม่ขัด C-01); เปิด/ปิด + กำหนดรางวัลได้ที่หลังบ้าน
