...
- FR-SV-03 แบบ B: **ระบบผูกผู้ดูแลอัตโนมัติ** จาก customer_assignments (snapshot ณ เวลาส่ง invitation) — **ไม่ให้ลูกค้าเลือกเองว่าประเมินใคร** (เดิมมีปุ่มเลือกหัวหน้า/ลูกทีม/ทั้งทีม/จำไม่ได้ → ยกเลิกตาม decision ผู้ใช้ 2026-07-15); แสดงผู้ดูแลที่ผูกมาแบบ read-only (รูป/ชื่อเล่น/ตำแหน่ง กันประเมินผิดคน) แล้ว render คำถามต่อคนอัตโนมัติ: หัวหน้าทีม 7 ข้อ + ลูกทีมที่ดูแลจริงคนละ 10 ข้อ
...
- FR-SC-01 **สำนักงาน (A): ส่งอัตโนมัติทุก 3 เดือน (วนซ้ำ)** นับจากรอบบริการ/วันเริ่ม (หรือรอบกลางรวม)
- FR-SC-01b **นักบัญชี (B): ส่งอัตโนมัติทุกเดือน — ต้นเดือน (วนซ้ำ)** ให้ประเมินผู้ดูแลที่ผูกจริงในเดือนนั้น
