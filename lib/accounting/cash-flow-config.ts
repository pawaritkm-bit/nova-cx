 ...
 *   ★ ไม่รวมรหัสค่าเสื่อมสะสม (`.1`) — ไม่มีทางจับคู่กับเงินสดโดยตรงอยู่แล้วจากลักษณะ double-entry
 *   ของรายการค่าเสื่อม (Dr ค่าเสื่อม / Cr ค่าเสื่อมสะสม ไม่มีขาไหนแตะเงินสด)
 */
export const INVESTING_CODES: string[] = ["1610", "1615", "1640", "1645"];
