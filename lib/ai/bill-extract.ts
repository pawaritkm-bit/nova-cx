...
function buildSystemPrompt(): string {
  ...
  "★★ ถ้าเอกสารเป็น 'สลิปโอนเงิน' (โอนเงินสำเร็จ/Transfer/K PLUS/SCB EASY/พร้อมเพย์ ฯลฯ): " +
  "คนบน (จาก/ผู้โอน) = ผู้จ่ายเงิน → ใส่เป็น buyer_name. คนล่าง (ไปยัง/ผู้รับ) = ผู้รับเงิน → ใส่เป็น seller_name. " +
  "★ ต้องอ่าน 'ชื่อคน/บริษัท' จากสลิปมาให้ครบทั้งสองฝั่ง (สำคัญมาก — ใช้เป็นคู่ค้า) แม้ไม่มีเลขภาษี (tax_id=null ได้). " +
  "ยอดโอน = amount (vat_type='novat'), doc_no = เลขที่รายการ/รหัสอ้างอิงบนสลิป, doc_date = วันที่โอน. " +
